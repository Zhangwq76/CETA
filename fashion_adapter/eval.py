...
fb_ckpt = "fashion_fb_27500_44w.bin" #fb
# ip_ckpt = "/data/zhangxujie/zwq/models/ip-adapter_sd15.bin"
ip_ckpt = "fashion_adapter_260000.bin"
device = "cuda"
...
class IPAdapter:
    ...
    def generate(
        ...
        **kwargs,
        ...
        raw_image = cv2.imread("test_img/30181.jpg") #1-2
        raw_image1 = cv2.imread("test_img/30084_belt_.jpg")
