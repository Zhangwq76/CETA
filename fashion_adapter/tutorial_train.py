...
tbwriter = SummaryWriter(log_dir=os.path.join('log', 'fb_strength_16token->1token_fashionsd_44w'))
...
def parse_args():
    ...
    parser.add_argument(
        "--data_json_file",
        type=str,
        default="/data/zhangxujie/zwq/IP-Adapter-main/train_data_big.json",
        help="Training data",
    )
    parser.add_argument(
        "--data_root_path",
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="fb_strength_16token->1token_fashionsd_44w",
