...
fb_ckpt = "/data/zhangxujie/zwq/IP-Adapter-main/fashion_fb_24000_44w.bin" #fb
...
class IPAdapter:
    ...
    def generate(
        ...
        **kwargs,
        ...
        raw_image = cv2.imread("/data/zhangxujie/zwq/IP-Adapter-main/test_img/30181_body_piece.jpg") #1-2
        raw_image1 = cv2.imread("/data/zhangxujie/zwq/IP-Adapter-main/test_img/30084_sleeve.jpg")
        # raw_image1 = cv2.imread("/data/zhangxujie/dataset/farfetch512/train_big/img/id_000000001.jpg")#47-3
        raw_image2 = cv2.imread("/data/zhangxujie/zwq/IP-Adapter-main/test_img/30084_belt_.jpg") #83_5
        ...
        text = ["sleeve","belt"]
        images_generate = image
        n=1
        for img, part_txt in zip(img_list,text):
            
            images_for_clip = images_generate
            clip_image1 = self.clip_image_processor(images=images_for_clip, return_tensors="pt").pixel_values
            clip_image2 = self.clip_image_processor(images=img, return_tensors="pt").pixel_values
            clip = torch.cat([clip_image1,clip_image2,empty,empty],dim=0)
            ...
            # print("part:",image_prompt_embeds.shape) #[1,4,1024]
            ...
            path= "eval/"+str(n)+".png"
            images_generate[0].save(path)
            # grid = self.image_grid(images_generate, 1,1)
            # grid.save(path)
            n=n+1
        return images_generate
