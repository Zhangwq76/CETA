##base on sd2-1 and 100w MScoco datasets
import os
import random
import argparse
...
tbwriter = SummaryWriter(log_dir=os.path.join('log', 'general_adapter'))
...
class MyDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        image_path = line
        text_path = line.replace("jpg","txt")
...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default="/data/zhangxujie/zwq/models/stable-diffsuion-2-1",
    ...
    parser.add_argument(
        "--data_json_file",
        type=str,
        default="/data/zhangxujie/zwq/IP-Adapter-main/general.txt",
        help="Training data",
    )
    parser.add_argument(
        "--data_root_path",
