...
def parse_user_input(user_input):
    ...
    @return: The GPT-generated response with extracted features in a dictionary format. -> json (str) format that need to change into dict
    """
    ...
    """
    OpenIssue: Here is in charge of the searching systems. We can improve its performance by fine-tuning the rules telling GPT.
    """
    for feature, values in feature_options.items():
        if feature != 'color':
            # Add a string describing the allowed values for the feature
    ...
    response = client.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": (
                ...
                f"only if they are mentioned in the user's request. If a feature is not explicitly mentioned by the user, "
    ...
    try:
        ...
        # get rid off Markdown's  ```json and ``` marks
...
if __name__ == '__main__':
    # Example: User input
    user_input = "I want a dress for the night party. Can you please give me an advice?"
